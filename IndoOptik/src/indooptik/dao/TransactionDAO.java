...
public class TransactionDAO {
	...
	public List<Transaction> retreiveALL() {
		String sql = "SELECT id_transaction, id_customer, id_lens, id_frame, name, telp, hp, birth_date, trx_date, lens, lens_color, frame, desc, pd FROM transaction ";
		...
		try {
			...
			while (rs.next()) {
				...
				transaction.setIdCostumer(rs.getString(2));
				...
				transaction.setPd(rs.getString(14));
	...
	public boolean insert(Transaction transaction) {
		...
		String sql = "INSERT INTO transaction VALUES ('"
				...
				+"', '"+transaction.getHP()+"', '"+dateFormat.format(transaction.getBirthDate())+"', '"+
				dateTimeFormat.format(transaction.getTransactionDate())+"', '"+transaction.getLens()+"', '"+
				transaction.getLensColor()+"','"+transaction.getFrame()+"','"+transaction.getDesc()+"','"+transaction.getPd()+"')";
		try {
