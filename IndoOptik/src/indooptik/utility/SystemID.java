...
public class SystemID {
	...
	public static synchronized String generate(String context, String codeToko){
		...
		lastValue.put(context, lastValue.get(context) + 1);
	...
	public static synchronized String generatePaymentCode(String context, String codeToko){
		...
		StringBuffer sb = new StringBuffer();
		sb.append(codeToko);
		sb.append(lastValue.get(context));
